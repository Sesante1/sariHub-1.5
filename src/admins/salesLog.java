...
public class salesLog extends  TransitionsForm{
    ...
    public void displayData() {
        try {
            ...
            ResultSet rs = dbc.getData(
                "SELECT DISTINCT DATE(Date) AS Sale_Date, " +  // Get distinct dates
                "(SELECT SUM(product_table.Price * sales.Quantity_Sold) " +  // Subquery to calculate total sales for the specific date
                " FROM sales " +
    ...
    private void initComponents() {
        ...
        roundPanel1.add(label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
